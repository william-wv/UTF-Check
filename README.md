...
**Título ou Nome da aplicação:** UTF-Check

**Identificação/Autor:** William Wendling Veiga , Leonardo Garcia e Eder Murilo de Morais

**Descrição do projeto:** Projeto criado para realizar ckecklist de etapas que garantem a qualidade de restaurantes universitários. Inicialmente para a o Campus de Guarapuava da UTFPR. 
...
1. Notyfy (Notificações)
2. Transloco (Translate)
3. fontawesome (Incons)


## Listas de API's utilizadas

1. Trello REST API => https://developer.atlassian.com/cloud/trello/rest/api-group-checklists/#api-checklists-id-field-get | API para checklists + comentarios
2. Firebase AUTH API => https://firebase.google.com/docs/reference/rest/auth | API para AUTH 

## Prototipação no Figma:

- https://www.figma.com/proto/KRNOw4CbciWHpcF1hJeEtl/R.U-Card%C3%A1pio?node-id=281-1971&p=f&t=pnlIv5bzPrZnOURN-0&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=281%3A1971
